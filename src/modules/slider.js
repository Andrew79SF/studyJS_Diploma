  const gallerySlider = () => {
    ...
    const gallerySliderWrap = document.querySelector('.gallery-slider'),
      slide = document.querySelectorAll('.gallery-slider .slide');

    gallerySliderWrap.style.position = 'relative';
    ...
    const addArrow = () => {
      ...
      gallerySliderWrap.appendChild(prev);
      gallerySliderWrap.appendChild(next);
    ...
    const getNewDot = () => {
      ...
      gallerySliderWrap.appendChild(parentDot);
    ...
    gallerySliderWrap.addEventListener('click', (event) => {
    ...
    gallerySliderWrap.addEventListener('mouseover', (event) => {
    ...
    gallerySliderWrap.addEventListener('mouseout', (event) => {
      if (event.target.closest('.glo-slider__next') ||
        event.target.closest('.glo-slider__prev') ||
        event.target.closest('.slider-dot')) {
        startSlide();
